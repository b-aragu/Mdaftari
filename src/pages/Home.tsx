                    ...
                    <div className="person-detail-panel">
                        <header className="person-detail-header">
                            ...
                            <div className="person-detail-title">
                                ...
                                <span className="person-detail-phone">{selectedPerson.phone || ''}</span>
                            </div>
                            <button
                                className="close-btn"
                                onClick={() => setSelectedPerson(null)}
                        ...
                        <div className="person-detail-summary">
                            <div className="summary-item">
                                <span className="summary-label">Total Received</span>
                                <span className="summary-value money-in">
                                    Ksh {formatMoney(selectedPerson.totalReceived)}
                                </span>
                            </div>
                            <div className="summary-item">
                                <span className="summary-label">Still Owed</span>
                                <span className="summary-value money-out">
                                    Ksh {formatMoney(selectedPerson.totalOwed)}
                                </span>
                            </div>
                        </div>

                        <div className="person-detail-transactions">
